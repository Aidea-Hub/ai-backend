...
class SmartLLMChain(Chain):
    ...
    def _ideate(
        ...
        """Generate n_ideas bad ideas as response to user prompt. These ideas should be the worst ideas you can think of."""
    ...
    def _critique(
        ...
        """Try to turn each of these terrible ideas from ideation stage into a good idea & select best one."""
