"""
This code is adapted and modified from langchain's experimental branch.
Original source code:
https://api.python.langchain.com/en/latest/_modules/langchain_experimental/smart_llm/base.html#SmartLLMChain
...
class SmartLLMChain(Chain):
        ...
        role_strings.extend(
            [
                *[
                ...
                (
                    HumanMessagePromptTemplate,
                    "You are a CEO of your company tasked with investigating the "
        ...
        role_strings.extend(
            [
                ...
                (
                    ...
                    "Return the idea in the following format:"
                    "<Idea Name (not more than 10 words)>:<One liner describing the idea (not more than 50 words)>",
                ),
            ]
        )
        if stage == "resolve":
    ...
    def _ideate(
        ...
        """Think of n_ideas wildcard and unique ideas that have never been thought of before to solve the given problem. The ideas can be as absurd as possible, as long as they solve the problem given."""
    ...
    def _critique(
        ...
        """Think of some reasons why the ideas are not feasible or why the ideas don't solve the problem. Improve upon the ideas by fixing the flaws in the ideas' feasibility or usefulness."""
    ...
    def _resolve(
        ...
        """Choose the best improved idea from the critique step & return it. The format should be Idea <Number>: <Idea Title>: <Idea Description>"""
