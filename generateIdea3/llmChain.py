...
class SmartLLMChain(Chain):
    ...
    def _ideate(
        ...
        """Think of n_ideas applications which might somewhat solve the problem given."""
    ...
    def _critique(
        ...
        """Think of reasons why these applications don't fully solve the problem given. Improve upon the existing applications to better solve the given problem."""
